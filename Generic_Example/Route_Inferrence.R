...
wind_positions<- read.csv(file = "P:/home/Documents/MSC_Thesis/wind_positions_16BG_DB.csv")



th_listconcat<- dist_wind_pos(wind_positions, tm)

wind_data<- read.csv(file = "P:/home/Documents/MSC_Thesis/16BG_WindDataDB.csv")
